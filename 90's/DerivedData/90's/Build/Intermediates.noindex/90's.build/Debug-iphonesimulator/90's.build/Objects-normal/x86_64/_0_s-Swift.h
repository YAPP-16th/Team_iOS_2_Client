...
- (IBAction)goToRoot:(id _Nonnull)sender;
- (IBAction)addPhoto:(id _Nonnull)sender;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified albumNameLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified themeImageView;
...
@interface AlbumDetailController (SWIFT_EXTENSION(_0_s)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
@end

@class UICollectionViewLayout;

@interface AlbumDetailController (SWIFT_EXTENSION(_0_s)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface AlbumDetailController (SWIFT_EXTENSION(_0_s)) <UICollectionViewDataSource>
...
@interface testViewController (SWIFT_EXTENSION(_0_s)) <AVCapturePhotoCaptureDelegate>
