...
SWIFT_CLASS("_TtC4_0_s20AlbumThemeController")
@interface AlbumThemeController : UIViewController
...
- (IBAction)kakaoInviteBtn:(UIButton * _Nonnull)sender;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4_0_s9ThemeCell")
@interface ThemeCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified themeImageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified themeNameLabel;
