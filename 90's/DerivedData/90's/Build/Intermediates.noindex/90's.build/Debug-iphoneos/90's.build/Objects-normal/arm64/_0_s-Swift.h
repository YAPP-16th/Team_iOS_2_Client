...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfPeriod;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfNumOfPhotos;
- (IBAction)goToRoot:(id _Nonnull)sender;
- (IBAction)saveSetting:(id _Nonnull)sender;
- (void)viewDidLoad;
...
@interface AlbumThemeController (SWIFT_EXTENSION(_0_s)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UITableViewCell;

@interface AlbumThemeController (SWIFT_EXTENSION(_0_s)) <UITableViewDataSource>
